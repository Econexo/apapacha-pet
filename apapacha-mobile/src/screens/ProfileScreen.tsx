...
const styles = StyleSheet.create({
  ...
  avatarImage: { width: 68, height: 68, borderRadius: 34, marginRight: 16 },
  ...
  catImage: { width: 80, height: 80, borderRadius: radii.md, marginRight: 16 },
  ...
  alertBlock: { backgroundColor: colors.dangerBg, padding: 12, borderRadius: radii.md },
  ...
  onboardingBtn: { backgroundColor: colors.warning, padding: 16, borderRadius: radii.lg, alignItems: 'center', marginTop: 16, marginBottom: 8, flexDirection: 'row', justifyContent: 'center', gap: 8 },
  onboardingBtnText: { color: colors.surface, fontWeight: '800', fontSize: 15 },
  hostTabHint: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: colors.primaryLight, borderRadius: radii.lg, padding: 14, marginTop: 12 },
  hostTabHintText: { fontSize: 13, color: colors.primaryDark, flex: 1 },
  applicationStatus: { flexDirection: 'row', alignItems: 'flex-start', backgroundColor: colors.surface, borderRadius: radii.lg, padding: 16, borderWidth: 2, marginTop: 16, marginBottom: 8, gap: 12 },
  ...
  settingsMenu: { backgroundColor: colors.surface, borderRadius: radii.lg, overflow: 'hidden', marginTop: 16, ...shadows.sm },
  ...
  contractSigned: { flexDirection: 'row', alignItems: 'center', backgroundColor: `${colors.success}10`, borderRadius: radii.lg, padding: 16, gap: 12 },
  ...
  contractPending: { backgroundColor: colors.infoBg, borderRadius: radii.lg, padding: 16 },
  contractPendingText: { fontSize: 13, color: colors.textMuted, lineHeight: 20, marginBottom: 12 },
  contractUploadBtn: { backgroundColor: colors.primary, paddingVertical: 14, borderRadius: radii.lg, alignItems: 'center', flexDirection: 'row', justifyContent: 'center', gap: 6 },
